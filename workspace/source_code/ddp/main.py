...
def main():
    ...
    parser.add_argument('--machines', default=2, type=int, help='number of machines')
    parser.add_argument('--gpus', default = 4, type=int, help='number of GPUs in a machine')
    parser.add_argument('--mid', default = 0, type=int, help='machine id number')
